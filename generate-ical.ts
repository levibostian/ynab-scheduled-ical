...
const ynabBudgetName = assertAndGetEnvVar("YNAB_BUDGET_NAME")
...
log.info("Uploading calendar file to GitHub Gist...")

await createOrUpdateGist({
  filePaths: ["./ynab_scheduled.ics"],
  secretGist: true,
  gistDescription: `YNAB scheduled transactions. Last updated: ${Date().toString()}`,
  gistDescriptionFilterablePhrase: "<generated by: github.com/levibostian/ynab-scheduled-ical>",
  log
})
